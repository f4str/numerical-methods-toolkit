...
def strassen_algorithm_square(A, B, levels):
    ...
    M_1 = strassen_algorithm_square(
        matrix_addition(A_11, A_22), matrix_addition(B_11, B_22), levels - 1
    )
    ...
    M_6 = strassen_algorithm_square(
        matrix_subtraction(A_21, A_11), matrix_addition(B_11, B_12), levels - 1
    )
    M_7 = strassen_algorithm_square(
        matrix_subtraction(A_12, A_22), matrix_addition(B_21, B_22), levels - 1
    )
